...
/**
 * @class NewrtConnectionRouter implements the AIR's serial timing-driven connection router
...
class NewrtConnectionRouter : public ConnectionRouter<HeapImplementation> {
  public:
