...
void NewrtConnectionRouter<Heap>::timing_driven_find_single_shortest_path_from_heap(RRNodeId sink_node,
...
template<typename Heap>
vtr::vector<RRNodeId, RTExploredNode> NewrtConnectionRouter<Heap>::timing_driven_find_all_shortest_paths_from_route_tree(
...
template<typename Heap>
vtr::vector<RRNodeId, RTExploredNode> NewrtConnectionRouter<Heap>::timing_driven_find_all_shortest_paths_from_heap(
    const t_conn_cost_params& cost_params,
    const t_bb& bounding_box) {
...
template<typename Heap>
void NewrtConnectionRouter<Heap>::timing_driven_expand_cheapest(RRNodeId from_node,
...
template<typename Heap>
void NewrtConnectionRouter<Heap>::timing_driven_expand_neighbours(const RTExploredNode& current,
                                                                   const t_conn_cost_params& cost_params,
                                                                   const t_bb& bounding_box,
                                                                   RRNodeId target_node,
                                                                   const t_bb& target_bb) {
...
template<typename Heap>
void NewrtConnectionRouter<Heap>::timing_driven_expand_neighbour(const RTExploredNode& current,
                                                                  RREdgeId from_edge,
                                                                  RRNodeId to_node,
                                                                  const t_conn_cost_params& cost_params,
                                                                  const t_bb& bounding_box,
...
template<typename Heap>
void NewrtConnectionRouter<Heap>::timing_driven_add_to_heap(const t_conn_cost_params& cost_params,
...
template<typename Heap>
void NewrtConnectionRouter<Heap>::add_route_tree_node_to_heap(
...
std::unique_ptr<ConnectionRouterInterface> make_newrt_connection_router(e_heap_type heap_type,
    ...
    switch (heap_type) {
        case e_heap_type::BINARY_HEAP:
            return std::make_unique<NewrtConnectionRouter<BinaryHeap>>(
                grid,
                router_lookahead,
                rr_nodes,
                rr_graph,
        ...
        case e_heap_type::FOUR_ARY_HEAP:
            return std::make_unique<NewrtConnectionRouter<FourAryHeap>>(
                grid,
                router_lookahead,
                rr_nodes,
                rr_graph,
