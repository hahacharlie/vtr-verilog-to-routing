...
template<typename Heap>
void NewrtConnectionRouter<Heap>::timing_driven_find_single_shortest_path_from_heap_sub_thread_wrapper(const size_t thread_idx) {
...
template<typename Heap>
void NewrtConnectionRouter<Heap>::timing_driven_find_single_shortest_path_from_heap_thread_func(RRNodeId sink_node,
                                                                                                   const t_conn_cost_params& cost_params,
                                                                                                   const t_bb& bounding_box,
                                                                                                   const t_bb& target_bb,
